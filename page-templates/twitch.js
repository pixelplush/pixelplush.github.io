...
const themeSettings = {
    ...
    "summercamp": {
        game: "maze",
        name: "Summer Camp (Premium)",
        page: "https://www.pixelplush.dev/maze/summercamp.html",
        preview: "/public/app-assets/images/games/summercamp.png",
        bosses: 0,
        trapEffect: 1,
        prizes: 14,
        traps: 5,
        messageFormat: "USERNAME finished with POINTS!",
        requires: "addon_maze_summercamp",
    },
    "springspree": {
        game: "maze",
    ...
    "boatchutes" : {
        game: "parachute",
        name: "Seafaring Chutes (Premium)",
        page: "https://www.pixelplush.dev/parachute/boat_chutes.html",
        preview: "/public/app-assets/images/games/boat_chutes.png",
        overlay: true,
        clouds: true,
        hideTilDrop: true,
        messageFormat: "USERNAME landed for POINTS!",
        command: "",
        requires: "addon_parachute_boat",
    },
...
function generateLink() {
    if( !channelName ) { return; } // Skip link generation while channel is undefined
    ...
    const oldLink = $( "#outputOverlayLink" ).val();
    const newLink = baseLink + linkParams.join( "&" );
    const hasLinkChanged = ( newLink !== oldLink );
    if( hasLinkChanged ) {
        $( "#outputOverlayLink" ).val( newLink );
        $( "#copy-btn" ).attr( "data-clipboard-text", newLink );
        if( oldLink ) {
            $( "#copy-btn" ).popover( {
                content: "Browser Source Link has changed! Click here to copy the updated link.",
                placement: "top",
                trigger: "hover focus",
            } );
