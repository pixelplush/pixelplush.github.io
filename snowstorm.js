...
(function() {
    ...
    if ( $.browser && $.browser.msie && parseInt($.browser.version) < 8) return;
    ...
    function createFlake(curX, curY) {
        ...
        if( $.browser && $.browser.msie && parseInt($.browser.version) < 10) //disable transparency on old IE to make rendering easier
            opacity = undefined;
        var color = '#FFF';
