        ...
        <div className="flex items-center gap-3">
          ...
          <span className="hidden lg:inline-flex items-center gap-1 text-xs text-[#4f2727]">
            ...
            <a
              ...
              className="inline-flex items-center gap-0.5 font-semibold text-[var(--color-pp-link)] hover:text-[#8B4513] transition-colors"
            >
              <Image
                src={assetPath("/app-assets/images/icon/maaya.gif")}
                alt=""
                width={24}
                height={24}
                className="pixelated"
            ...
            >
              Instafluff
              <Image
                src={assetPath("/app-assets/images/icon/instafluff.gif")}
                alt=""
                width={26}
                height={26}
                className="pixelated"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={langRef}>
            <button
              ...
              className="flex items-center gap-1.5 px-2 py-1.5 rounded hover:bg-[var(--color-pp-card-hover)] transition-colors text-sm text-[var(--color-pp-text)]"
            >
            ...
            {langOpen && (
              <div className="absolute top-full mt-1 right-0 w-40 rounded-lg bg-white border border-gray-200 shadow-xl py-1 z-50">
                {languages.map((lang) => (
                  <button
                    key={lang.code}
