...
export default function LinksPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="mb-2 text-3xl font-bold text-[var(--color-pp-headings)]">{t('links.aboutTitle')}</h1>
      <p className="mb-8 text-[var(--color-pp-text-muted)]">{t('links.aboutSubtitle')}</p>
      ...
      <div className="rounded-2xl border border-[var(--color-pp-border)] bg-[var(--color-pp-card)] p-6">
        <h2 className="mb-2 text-xl font-semibold text-[var(--color-pp-headings)]">{t('links.streamBannersTitle')}</h2>
        <p className="mb-6 text-sm text-[var(--color-pp-text-muted)]">{t('links.streamBannersDescription')}</p>
      ...
      {/* Game Jam Games */}
      <div className="mt-12">
        <h2 className="mb-2 text-xl font-semibold text-[var(--color-pp-headings)]">{t('links.gameJamGamesTitle')}</h2>
        <p className="mb-6 text-sm text-[var(--color-pp-text-muted)]">{t('links.gameJamGamesDescription')}</p>
      ...
      {/* Credits */}
      <div className="mt-12">
        <h2 className="mb-2 text-xl font-semibold text-[var(--color-pp-headings)]">{t('links.creditsTitle')}</h2>
        <p className="mb-8 text-[var(--color-pp-text-muted)]">{t('links.creditsSubtitle')}</p>
        ...
        <div className="space-y-8">
          {credits.map((section) => (
            ...
            >
              <h3 className="mb-4 text-xl font-semibold text-[var(--color-pp-headings)]">{section.game}</h3>
